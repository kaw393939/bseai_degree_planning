...
description: "Matrix mapping Human Edge capabilities to ABET student outcomes across all eight studio courses."
---

# Outcomes Mapping: Human Edge × ABET × Courses

This matrix shows how each Human Edge capability maps to ABET CAC student outcomes and where each is Introduced (I), Reinforced (R), or Mastered (M) across the eight studio courses.

---

## ABET Outcomes × Human Edge Capabilities
...
## Curriculum Map: I-R-M Progression

Shows where each ABET outcome is Introduced, Reinforced, and Mastered across the spine.
...
## Human Edge Accumulation

Each Human Edge is introduced in its home studio and reinforced in every subsequent course:
...
## Assessment Evidence by Outcome

### (1) Analyze Complex Computing Problems

| Course | Evidence |
|---|---|
| IS 117 | Inquiry logs — structured question decomposition |
| IS 265 | Problem framing memos — root cause analysis in organizational context |
| IS 331 | Data assumptions documents — what the data captures vs. distorts |
| IS 390 | Systems decomposition — mapping component interactions and emergent behavior |
| IS 425 | Capstone requirements analysis with AI components |

### (2) Design, Implement, and Evaluate Solutions
...
### (4) Ethical/Professional Judgment
...
- [ABET CAC Alignment](/bseai_degree_planning/accreditation/abet-alignment/) — Full criteria mapping
- [Assessment Plan](/bseai_degree_planning/accreditation/assessment-plan/) — Measurement methodology
- [The Human Edge Framework](/bseai_degree_planning/curriculum/outcomes/) — Capability definitions
- [Learning Objectives](/bseai_degree_planning/program/learning-objectives/) — Course-level Bloom's-aligned objectives
